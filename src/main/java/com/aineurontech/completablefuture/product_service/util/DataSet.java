...
import com.aineurontech.completablefuture.product_service.checkout.Cart;
...
public class DataSet {
    ...
    public static List<String> lowerCaseAlphabetList = ImmutableList.of("a", "b", "c", "a", "d", "e", "f", "e", "g", "h", "i");
    ...
    public static List<String> namesList() {
        return ImmutableList.of("Bob", "Jamie", "Jill", "Rick");
